 ...
 * This selects the following:
 LotAreaTrans*LotAreaTrans OverallQualTrans OverallQualTrans*OverallQualTrans YearRemodAddTrans*YearRemodAddTrans BsmtFinSF1*BsmtFinSF1 BsmtFinSF1Flag TotalBsmtSFTrans _2ndFlrSF GrLivAreaTrans GrLivAreaTrans*GrLivAreaTrans BsmtFullBath*BsmtFullBath KitchenAbvGr*KitchenAbvGr Fireplaces GarageCars*GarageCars GarageArea
*/
...
/* This selects:
BsmtFinSF1*BsmtFullBath _2ndFlrSF*GarageCars OverallQualTrans Fireplaces*OverallCondTrans LotAreaTrans*OverallCondTrans YearRemodAddTrans OverallQualTrans*YearRemodAddTrans KitchenAbvGr*BsmtFinSF1Flag LotAreaTrans*TotalBsmtSFTrans OverallQualTrans*GrLivAreaTrans KitchenAbvGr*BedroomAbvGrTrans BsmtFullBath*Col16 BsmtFinSF1*Col34 BsmtFinSF1Flag*Col69 TotRmsAbvGrd*Col76 Col39*Col107 GarageArea*Col119 Col43*Col130 BsmtFinSF1*Col160 Col3*Col173 Col38*Col193 Col167*Col194 TotRmsAbvGrd*Col199 OverallQualTrans*Col217 Col119*Col221 Fireplaces*Col222 Col86*Col225 Col5*Col227 BsmtFinSF1*Col231 WoodDeckSF*Col232 Col14*Col237 Col5*Col256 Col228*Col260 TotalBsmtSFTrans*Col261
 */
...
proc glmselect data=train NAMELEN=200;
	model SalePriceSqrt=
/* first and second order of polynomial */
LotAreaTrans*LotAreaTrans OverallQualTrans OverallQualTrans*OverallQualTrans YearRemodAddTrans*YearRemodAddTrans BsmtFinSF1*BsmtFinSF1 BsmtFinSF1Flag TotalBsmtSFTrans _2ndFlrSF GrLivAreaTrans GrLivAreaTrans*GrLivAreaTrans BsmtFullBath*BsmtFullBath KitchenAbvGr*KitchenAbvGr Fireplaces GarageCars*GarageCars GarageArea
/* interactions */
BsmtFinSF1*BsmtFullBath _2ndFlrSF*GarageCars OverallQualTrans Fireplaces*OverallCondTrans LotAreaTrans*OverallCondTrans YearRemodAddTrans OverallQualTrans*YearRemodAddTrans KitchenAbvGr*BsmtFinSF1Flag LotAreaTrans*TotalBsmtSFTrans OverallQualTrans*GrLivAreaTrans KitchenAbvGr*BedroomAbvGrTrans BsmtFullBath*Col16 BsmtFinSF1*Col34 BsmtFinSF1Flag*Col69 TotRmsAbvGrd*Col76 Col39*Col107 GarageArea*Col119 Col43*Col130 BsmtFinSF1*Col160 Col3*Col173 Col38*Col193 Col167*Col194 TotRmsAbvGrd*Col199 OverallQualTrans*Col217 Col119*Col221 Fireplaces*Col222 Col86*Col225 Col5*Col227 BsmtFinSF1*Col231 WoodDeckSF*Col232 Col14*Col237 Col5*Col256 Col228*Col260 TotalBsmtSFTrans*Col261
 / selection=STEPWISE(stop=CV) cvMethod=RANDOM(5);
...
/* This selects:
OverallQualTrans YearRemodAddTrans*YearRemodAddTrans BsmtFinSF1Flag BsmtFinSF1*BsmtFullBath _2ndFlrSF*GarageCars Fireplaces*OverallCondTrans LotAreaTrans*OverallCondTrans OverallQualTrans*YearRemodAddTrans LotAreaTrans*TotalBsmtSFTrans OverallQualTrans*GrLivAreaTrans KitchenAbvGr*BedroomAbvGrTrans BsmtFullBath*Col16 BsmtFinSF1*Col34 BsmtFinSF1Flag*Col69 TotRmsAbvGrd*Col76 Col39*Col107 GarageArea*Col119 Col43*Col130 BsmtFinSF1*Col160 Col3*Col173 Col38*Col193 Col167*Col194 TotRmsAbvGrd*Col199 OverallQualTrans*Col217 Col119*Col221 Fireplaces*Col222 Col86*Col225 Col5*Col227 BsmtFinSF1*Col231 Col14*Col237 Col5*Col256 Col228*Col260 TotalBsmtSFTrans*Col261
 */
